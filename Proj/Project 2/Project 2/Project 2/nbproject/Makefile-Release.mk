...
${OBJECTDIR}/BaseBS.o: BaseBS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BaseBS.o BaseBS.cpp

${OBJECTDIR}/DerivBS.o: DerivBS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DerivBS.o DerivBS.cpp
